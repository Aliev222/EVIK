...
func validProductionConfig() Config {
	return Config{
		...
		YooKassaPayoutGatewayID: "gateway",
		YooKassaPayoutSecret:    "payout-secret",
		YooKassaPayoutMode:      "live",
...
func TestProductionConfigRejectsFakeFinancialModes(t *testing.T) {
	for name, mutate := range map[string]func(*Config){
		...
		"missing payout credentials": func(cfg *Config) {
			cfg.YooKassaPayoutGatewayID = ""
			cfg.YooKassaPayoutSecret = ""
		},
	} {
...
func TestProductionConfigAcceptsLiveProviderConfiguration(t *testing.T) {
