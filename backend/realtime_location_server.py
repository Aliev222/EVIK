...
async def main():
    ...
    logger.info("📡 WebSocket server will run on ws://localhost:8766")
    logger.info("🔧 Admin panel: ws://localhost:8766")
    logger.info("👨‍💼 Driver apps: ws://localhost:8766")
    logger.info("👤 Client apps: ws://localhost:8766")
